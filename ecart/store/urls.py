...
urlpatterns = [
    ...
    path('main_category/<slug:main_category_slug>/<slug:category_slug>/',views.store,name='product_by_category'),
    path('main_category/<slug:main_category_slug>/<slug:category_slug>/<slug:sub_category_slug>/',views.store,name='product_by_sub_category'),
