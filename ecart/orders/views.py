...
def payments(request):
    ...
    #  2.reduce the quantity of the sold products
    ...
    # send order number and transaction id back t o sendData f'n method using jawa    
    data = {
...
def place_order(request, total=0, quantity=0):
    ...
    #check whether cart count<=0 then redirect to store
    ...
    tax         = (2*total)/100                                         #total tax
    grand_total = total + tax                                   #total bill
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            data.save() 
            #once saved primarykey is generated(order id) 
